---
学习概念: "大语言模型（LLM / Model）"
英文/别名: "Large Language Model / LLM"
领域: "人工智能"
生成方式: "topic-research（概念学习模式）· concept-learner 规范 Skill"
日期: "2026-09-09"
核查状态: "已人工核查（本人通读并修改）"
---
...
我的理解：**LLM 是"读了海量文字、靠'预测下一个词'练出来的巨型神经网络"**——它把人类写过的书、网页、代码都读进参数里，直接跳过"背答案"这条路径，转而练就"接着写下去"的语言规律，于是给它一句话，它能续写、能问答、能推理、能写代码。
